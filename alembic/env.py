...
def get_project_models_metadata():
    metadata_list = []
    for app_module in settings.APP_MODULES:
        module = importlib.import_module(f"{settings.APP_NAME}.modules.{app_module}.models")
...
# Ensure we load all our models to get the metadata
metadata_list = get_project_models_metadata()
